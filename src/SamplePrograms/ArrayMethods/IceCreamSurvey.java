...
public class IceCreamSurvey {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Here are the people that like vanilla: ");
        for (int i = 0; i < vnames.length; i++) 
            System.out.print(vnames[i]+", ");
        System.out.println("\n---------------------------");
        
        System.out.println("Here are the people that like chocolate: ");
        for (int i = 0; i < cnames.length; i++) 
            System.out.print(cnames[i]+", ");
        System.out.println("\n---------------------------");
        
        System.out.println("Here are the people that like strawberry: ");
