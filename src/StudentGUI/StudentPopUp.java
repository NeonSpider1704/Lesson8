...
public class StudentPopUp extends javax.swing.JDialog {
    ...
    public void setForm(Student s){
       ...
       for (int i = 0; i < 3; i++) {
           tbl_marks.setValueAt(s.getMark(i+1),0,i);
       }
   }
    ...
    private void initComponents() {
        ...
        tbl_marks.setRowSelectionAllowed(false);
    ...
    private void btn_okActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_okActionPerformed
        ...
        try{
            marks[0] = Integer.parseInt(tbl_marks.getValueAt(0,0).toString());
            marks[1] = Integer.parseInt(tbl_marks.getValueAt(0,1).toString());
            marks[2] = Integer.parseInt(tbl_marks.getValueAt(0,2).toString());
        }catch(Exception e){
